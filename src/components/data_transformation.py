...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("numerical column scading completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("applying the preprocessing object on training dataframe and test dataframe")
            input_feature_train_array = preprocessing_obj.fit_transform(input_feature_train_df)
            input_feature_test_array = preprocessing_obj.fit_transform(input_feature_test_df)
            train_arr = np.c_[input_feature_train_array,np.array(target_feature_train_df)] # combines both array and create one array, first array k column,followed by other array column in horizontal
